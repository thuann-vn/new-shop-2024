...
class ProductsRelationManager extends RelationManager
{
    ...
    public function form(Form $form): Form
    {
        ...
        $schema[] = Forms\Components\TextInput::make('sku')
            ->label('SKU')
            ->unique('shop_product_variants', 'sku')
            ->required();

//        $schema[] = Forms\Components\TextInput::make('barcode')
//            ->label('Barcode')
//            ->required();

//        $schema[] = Forms\Components\TextInput::make('stock')
//            ->type('number')
//            ->numeric()
//            ->label('Stock')
//            ->required();

//        $schema[] = Forms\Components\Checkbox::make('requires_shipping')
