...
>
    <div class="relative group">
        <div @class([
            ...
            <button
                type="button"
                wire:click="editItem('{{ $statePath }}', '{{ $locale }}')"
        ...
        <div @class([
            ...
            <button
                ...
                type="button"
                wire:click="addChild('{{ $statePath }}', '{{ $locale }}')"
                class="p-1"
            ...
            <button
                ...
                type="button"
                wire:click="removeItem('{{ $statePath }}', '{{ $locale }}')"
                class="p-1"
    ...
    <div x-show="open" x-collapse class="ml-6">
        ...
        >
            ...
            @endphp
            @foreach ($items as $uuid => $child)
                <x-filament-navigation::nav-item :locale="$locale" :statePath="$statePath . '.children.' . $uuid" :item="$child" />
            @endforeach
        </div>
    </div>
</div>
