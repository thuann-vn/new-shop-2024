        ...
        <>
            ...
            <div className="mt-10 pb-10 container mx-auto  px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center border-b bg-white py-4 sm:flex-row">
                    <a href={route('checkout')} className="text-2xl font-bold text-gray-800">
                        {t('Summary')}
                    </a>
                ...
                <div className="mt-6">
                    <h1 className="text-sm font-semibold uppercase tracking-wide text-main-600">
                        {t('Thank you!')}
                    </h1>
                    <p className="mt-2 text-4xl font-extrabold tracking-tight sm:text-5xl">{t('Your order is placed!')}</p>
                    <p className="mt-2 text-base text-gray-500">
                        {t('Your order #{{order_number}} has been placed and will be processed as soon as possible.',{
