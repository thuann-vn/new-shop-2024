        ...
        <footer className="pt-10 bg-gray-800">
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
                    <p className="text-gray-300">© 2023 Float UI Inc. All rights reserved.</p>
                    <div className="flex items-center gap-x-6 text-gray-400 mt-6">
                        <a href={general_settings.site_facebook}>
                        ...
                        <a href={general_settings.site_twitter}>
                        ...
                        <a href={general_settings.site_youtube}>
                        ...
                        <a href={general_settings.site_instagram}>
